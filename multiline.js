...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "multiline.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "multiline.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'multiline'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'multiline':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_0831301253d0081f3aa63ccb87eb5ef601d2d40f": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);location.hash=($0);
            },
            ...
            "__cargo_web_snippet_6f2de3f9c3515941846c3a133dd955714a018ce7": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return location.hash;})());
            },
